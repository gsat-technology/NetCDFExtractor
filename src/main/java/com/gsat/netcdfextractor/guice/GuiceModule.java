...
public class GuiceModule extends AbstractModule {
    ...
    public GuiceModule(String s3Store, String maxDownloadByteSize, String publicWebsiteUrl, AmazonS3 s3Client) {
    ...
    protected void configure() {
        ...
        bindConstant().annotatedWith(Names.named("maxDownloadByteSize")).to(this.maxDownloadByteSize);
